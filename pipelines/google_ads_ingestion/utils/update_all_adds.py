...
def update_all_ads(
    ...
    try:
        ...
        query_job.result()
        logging.info(f"All ads updated successfully for advertisers in `{advertiser_ids_table}`.")
        print(f"All ads updated successfully for advertisers in `{advertiser_ids_table}`.")
